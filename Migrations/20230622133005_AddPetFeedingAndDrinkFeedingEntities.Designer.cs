...
namespace InnoGotchi_backend.Migrations
{
    ...
    [Migration("20230622133005_AddPetFeedingAndDrinkFeedingEntities")]
    partial class AddPetFeedingAndDrinkFeedingEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InnoGotchi_backend.Models.Entity.Pet", b =>
                {
                    ...
                    b.Property<DateTime>("LastHappyDaysCountUpdated")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("InnoGotchi_backend.Models.Entity.PetDrinking", b =>
                {
                    ...
                    b.ToTable("PetDrinking");
                });

            modelBuilder.Entity("InnoGotchi_backend.Models.Entity.PetFeeding", b =>
                {
            ...
            modelBuilder.Entity("InnoGotchi_backend.Models.Entity.PetDrinking", b =>
                {
                    b.HasOne("InnoGotchi_backend.Models.Entity.Pet", "MyPet")
                        .WithMany("Drinkings")
                        .HasForeignKey("PetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
